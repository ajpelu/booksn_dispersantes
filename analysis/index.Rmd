...
- Explore [**abundance**](abundance.html). Graphic outputs are stored at  `/output/mktrend`). 

- [**Turnover analysis**](turnover.html). Graphic outputs are stored at  `/output/mktrend`). 

- [**Composed plot**](composed_plot.html). Graphic outputs are stored at  `/output/mktrend`). 
